              ...
              <Table responsive>
                <thead className="text-white bg-dark">
                  <tr>
                    ...
                    <th style={tableHeaderStyle}>ShippingMethod</th>
                    <th style={tableHeaderStyle}>paymetMethod</th>
                  </tr>
                </thead>
                <tbody>
                  {currentItems?.map((item, index) => (
                    <tr key={item.id}>
                      ...
                      <td style={tableCellStyle}>{item.shippingMethod}</td>
                      <td style={tableCellStyle}>{item.paymetMethod}</td>
